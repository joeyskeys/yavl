...
struct alignas(16) Vec<float, 4> {
    ...
    // Operators
    YAVL_DEFINE_VEC_FP_OP(Vec,, ps, ps)
...
struct alignas(16) Vec<double, 2> {
    ...
    // Operators
    YAVL_DEFINE_VEC_FP_OP(Vec,, pd, pd)
...
template <typename I>
struct alignas(16) Vec<I, 4, enable_if_int32_t<I>> {
...
template <typename I>
struct alignas(16) Vec<I, 3, enable_if_int32_t<I>> {
...
struct alignas(16) Vec<I, 2, enable_if_int64_t<I>> {
    ...
    // Operators
    YAVL_DEFINE_VEC_INT_OP(Vec,, epi32, si128)
