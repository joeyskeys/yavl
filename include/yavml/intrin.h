...
#include <yavml/platform.h>

#if defined(ARCH_X86_64) || defined(ARCH_X86_32)
#   include <immintrin.h>
#endif

#if defined(YAVML_ARM_NEON)
#   include <arm_neon.h>
#endif
...
template <typename T, uint32_t Size>
using intrinsic_type_t = intrinsic_type<T, Size>::type;
